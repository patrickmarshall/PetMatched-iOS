//
//  DAOInputHistoryBaseClass.swift
//
...
public final class DAOInputHistoryBaseClass: NSCoding {
  ...
  public var errorMsg: DAOInputHistoryErrorMsg?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOInputHistoryErrorMsg(json: json[SerializationKeys.errorMsg])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOInputHistoryErrorMsg
