...
public final class DAOSettingBaseClass: NSCoding {
  ...
  public var errorMsg: DAOSettingErrorMsg?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOSettingErrorMsg(json: json[SerializationKeys.errorMsg])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOSettingErrorMsg
