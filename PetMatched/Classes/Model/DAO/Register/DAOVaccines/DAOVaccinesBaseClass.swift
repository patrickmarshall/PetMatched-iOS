...
public final class DAOVaccinesBaseClass: NSCoding {
  ...
  public var errorMsg: DAOVaccinesErrorMsg?
  public var response: DAOVaccinesResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOVaccinesErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOVaccinesResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOVaccinesErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOVaccinesResponse
