...
public final class DAOInputBaseClass: NSCoding {
  ...
  public var errorMsg: DAOInputErrorMsg?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOInputErrorMsg(json: json[SerializationKeys.errorMsg])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOInputErrorMsg
