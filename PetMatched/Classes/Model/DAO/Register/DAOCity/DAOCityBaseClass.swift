...
public final class DAOCityBaseClass: NSCoding {
  ...
  public var errorMsg: DAOCityErrorMsg?
  public var response: DAOCityResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOCityErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOCityResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOCityErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOCityResponse
