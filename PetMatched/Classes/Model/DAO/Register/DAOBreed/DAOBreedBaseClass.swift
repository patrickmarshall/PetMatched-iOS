//
//  DAOBreedBaseClass.swift
//
//  Created by Patrick Marshall on 5/6/18
...
public final class DAOBreedBaseClass: NSCoding {
  ...
  public var errorMsg: DAOBreedErrorMsg?
  public var response: DAOBreedResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOBreedErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOBreedResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOBreedErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOBreedResponse
