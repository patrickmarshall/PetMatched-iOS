//
//  DAOCheckUsernameBaseClass.swift
//
...
public final class DAOCheckUsernameBaseClass: NSCoding {
  ...
  public var errorMsg: DAOCheckUsernameErrorMsg?
  public var response: DAOCheckUsernameResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOCheckUsernameErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOCheckUsernameResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOCheckUsernameErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOCheckUsernameResponse
    self.error = aDecoder.decodeObject(forKey: SerializationKeys.error) as? Bool
  }
