...
public final class DAORegisterBaseClass: NSCoding {
  ...
  public var errorMsg: DAORegisterErrorMsg?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAORegisterErrorMsg(json: json[SerializationKeys.errorMsg])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAORegisterErrorMsg
