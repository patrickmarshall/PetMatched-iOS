...
public final class DAOLoginBaseClass: NSCoding {
  ...
  public var errorMsg: DAOLoginErrorMsg?
  public var response: DAOLoginResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOLoginErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOLoginResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOLoginErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOLoginResponse
