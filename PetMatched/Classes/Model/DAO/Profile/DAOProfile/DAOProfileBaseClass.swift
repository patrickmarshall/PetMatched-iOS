...
public final class DAOProfileBaseClass: NSCoding {
  ...
  public var errorMsg: DAOProfileErrorMsg?
  public var response: DAOProfileResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOProfileErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOProfileResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOProfileErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOProfileResponse
