...
public final class DAOPetResponse: NSCoding {
  ...
  public var vaccines: [DAOPetVaccines]?
  ...
  public required init(json: JSON) {
    ...
    breed = json[SerializationKeys.breed].int
    id = json[SerializationKeys.id].int
    breedName = json[SerializationKeys.breedName].string
    furcolor = json[SerializationKeys.furcolor].string
    if let items = json[SerializationKeys.vaccines].array { vaccines = items.map { DAOPetVaccines(json: $0) } }
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = breed { dictionary[SerializationKeys.breed] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.breed = aDecoder.decodeObject(forKey: SerializationKeys.breed) as? Int
    ...
    self.vaccines = aDecoder.decodeObject(forKey: SerializationKeys.vaccines) as? [DAOPetVaccines]
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(breed, forKey: SerializationKeys.breed)
