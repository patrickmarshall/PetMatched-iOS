...
public final class DAOPetBaseClass: NSCoding {
  ...
  public var errorMsg: DAOPetErrorMsg?
  public var response: DAOPetResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOPetErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOPetResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOPetErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOPetResponse
