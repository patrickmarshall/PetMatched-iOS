...
public final class DAOChatListBaseClass: NSCoding {
  ...
  public var errorMsg: DAOChatListErrorMsg?
  public var response: DAOChatListResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOChatListErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOChatListResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOChatListErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOChatListResponse
