...
public final class DAORoomListBaseClass: NSCoding {
  ...
  public var errorMsg: DAORoomListErrorMsg?
  public var response: DAORoomListResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAORoomListErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAORoomListResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAORoomListErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAORoomListResponse
