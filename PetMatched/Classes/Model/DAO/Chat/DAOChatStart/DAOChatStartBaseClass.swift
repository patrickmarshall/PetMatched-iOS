...
public final class DAOChatStartBaseClass: NSCoding {
  ...
  public var errorMsg: DAOChatStartErrorMsg?
  public var response: DAOChatStartResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOChatStartErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOChatStartResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOChatStartErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOChatStartResponse
