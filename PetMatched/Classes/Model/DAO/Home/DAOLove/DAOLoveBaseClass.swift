...
public final class DAOLoveBaseClass: NSCoding {
  ...
  public var errorMsg: DAOLoveErrorMsg?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOLoveErrorMsg(json: json[SerializationKeys.errorMsg])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOLoveErrorMsg
