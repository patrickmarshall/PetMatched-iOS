...
public final class DAOMatchedBaseClass: NSCoding {
  ...
  public var errorMsg: DAOMatchedErrorMsg?
  public var response: DAOMatchedResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOMatchedErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOMatchedResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOMatchedErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOMatchedResponse
