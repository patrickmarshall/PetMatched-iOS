...
public final class DAOLikedLikedPet: NSObject, NSCoding {
  ...
  // MARK: Properties
  public var matchedStatus: DAOLikedMatchedStatus?
  ...
  public var userData: DAOLikedUserData?
  public var id: Int?
  public var breedName: String?
  public var furcolor: String?
  public var vaccines: [DAOLikedVaccines]?
  ...
  public required init(json: JSON) {
    matchedStatus = DAOLikedMatchedStatus(json: json[SerializationKeys.matchedStatus])
    ...
    userData = DAOLikedUserData(json: json[SerializationKeys.userData])
    id = json[SerializationKeys.id].int
    breedName = json[SerializationKeys.breedName].string
    furcolor = json[SerializationKeys.furcolor].string
    if let items = json[SerializationKeys.vaccines].array { vaccines = items.map { DAOLikedVaccines(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.matchedStatus = aDecoder.decodeObject(forKey: SerializationKeys.matchedStatus) as? DAOLikedMatchedStatus
    ...
    self.userData = aDecoder.decodeObject(forKey: SerializationKeys.userData) as? DAOLikedUserData
    ...
    self.vaccines = aDecoder.decodeObject(forKey: SerializationKeys.vaccines) as? [DAOLikedVaccines]
