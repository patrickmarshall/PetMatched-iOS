...
public final class DAOLikedBaseClass: NSCoding {
  ...
  public var errorMsg: DAOLikedErrorMsg?
  public var response: DAOLikedResponse?
  ...
  public required init(json: JSON) {
    ...
    errorMsg = DAOLikedErrorMsg(json: json[SerializationKeys.errorMsg])
    response = DAOLikedResponse(json: json[SerializationKeys.response])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.errorMsg = aDecoder.decodeObject(forKey: SerializationKeys.errorMsg) as? DAOLikedErrorMsg
    self.response = aDecoder.decodeObject(forKey: SerializationKeys.response) as? DAOLikedResponse
